package id.umn.ac.week07b_32587;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void isiDaftarVideo(){
        ...
        daftarVideo.add(new SumberVideo("Kejar-kejaran", "Kejar-kejaran di jalanan hasil cuplikan film The Fast and The Furious", "android.resource://" +getPackageName() + "/"+R.raw.drift02));
